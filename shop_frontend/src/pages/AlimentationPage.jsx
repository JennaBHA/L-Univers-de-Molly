  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const alimentation = response.data.filter(
          (product) => product.category?.toLowerCase() === "alimentation"
        );
        setProducts(alimentation);
        setFilteredProducts(alimentation);
        setLoading(false);
      } catch (err) {
  ...
  useEffect(() => {
    ...
    if (selectedType !== "all") {
      filtered = filtered.filter((product) => {
        ...
        return (
          product.foodType &&
          product.foodType.toLowerCase() === selectedType.toLowerCase()
        );
      });
    }
