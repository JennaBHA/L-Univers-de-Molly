...
const DashboardProducts = () => {
    const products = [
        { id: 1, name: 'Laisse Premium', category: 'Chiens', price: 24.99, stock: 45, status: 'En stock' },
        { id: 2, name: 'Arbre à chat Deluxe', category: 'Chats', price: 89.99, stock: 12, status: 'Faible' },
        { id: 3, name: 'Croquettes Bio', category: 'Alimentation', price: 34.50, stock: 0, status: 'Rupture' },
        { id: 4, name: 'Jouet Balle', category: 'Jouets', price: 9.99, stock: 120, status: 'En stock' },
    ];

    const getStatusColor = (status) => {
        switch (status) {
            case 'En stock': return 'bg-green-100 text-green-600';
            case 'Faible': return 'bg-orange-100 text-orange-600';
            case 'Rupture': return 'bg-red-100 text-red-600';
